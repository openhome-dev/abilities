...
class MathAssistantCapability(MatchingCapability):
    ...
    async def run(self):
        ...
        await self.capability_worker.speak(
            ...
            "solve equations, convert units, or explain math concepts. What would you like to do?"
        )
        ...
        while True:
            ...
            follow_up = await self.capability_worker.run_io_loop(
                response + " Would you like help with anything else? Say 'no' to exit."
            )
    ...
    async def _process_math_request(self, user_input: str) -> str:
        ...
        # Unit conversion
        if any(word in user_lower for word in ['convert', 'to', 'in', 'feet', 'meters', 'miles', 'kilometers', 'pounds', 'kilograms']):
            return await self._handle_conversion(user_input)

        # Equation solving
        if any(word in user_lower for word in ['solve', 'equation', 'find x', 'what is x']):
        ...
        # Powers/exponents
        if any(word in user_lower for word in ['power', 'squared', 'cubed', 'to the power']):
    ...
    async def _handle_calculation(self, expression: str) -> str:
        ...
        try:
            ...
            return f"I couldn't calculate that. Please try saying it differently, like 'what is 5 plus 3' or 'calculate 10 times 4'."
    ...
    async def _handle_conversion(self, user_input: str) -> str:
        ...
        try:
            ...
            return "I can convert between feet and meters, miles and kilometers, pounds and kilograms, Celsius and Fahrenheit, and more. What would you like to convert?"
    ...
    async def _handle_equation(self, user_input: str) -> str:
        ...
        try:
            ...
            return "I can solve simple equations like '2x plus 3 equals 7' or 'x minus 5 equals 10'. What equation would you like me to solve?"
    ...
    async def _handle_percentage(self, user_input: str) -> str:
        ...
        try:
            ...
            return "I can calculate percentages like 'what is 20 percent of 100' or '50 is what percent of 200'. What would you like to know?"
    ...
    async def _handle_power(self, user_input: str) -> str:
        ...
        try:
            ...
            return "I can calculate powers. Try saying '2 to the power of 5' or 'what is 3 squared'."
    ...
    def _clean_expression(self, expression: str) -> str:
        ...
        # Remove any non-math characters except operators and digits
    ...
    def _safe_eval(self, expression: str):
        ...
        # Create safe dictionary with only allowed operations
    ...
    def _convert_units(self, user_input: str) -> str:
        ...
        return "I can convert between miles and kilometers, feet and meters, pounds and kilograms, and Fahrenheit and Celsius. What would you like to convert?"
    ...
    def _solve_simple_equation(self, equation: str) -> str:
        ...
        try:
            ...
            return "I can solve simple equations like '2x plus 3 equals 7' or 'x minus 5 equals 10'. Could you rephrase your equation?"
        except:
            return "I can solve simple linear equations. Try saying something like 'solve 2x plus 3 equals 7'."
    ...
    def _calculate_percentage(self, user_input: str) -> str:
        ...
        return "I can calculate percentages. Try saying 'what is 20 percent of 100' or '50 is what percent of 200'."
    ...
    def _calculate_power(self, user_input: str) -> str:
        ...
        return "I can calculate powers. Try saying 'what is 2 to the power of 5' or 'what is 3 squared'."

    def _is_exit_command(self, text: str) -> bool:
        """Check if user wants to exit."""
        exit_words = ['no', 'exit', 'quit', 'stop', 'done', 'goodbye', 'bye', 'thanks', 'thank you']
        return text.lower().strip() in exit_words or text.lower().strip().rstrip('.') in exit_words
