...
## What It Does
Search for freelance jobs on Upwork using voice. Simply say what type of job you're looking for (like "web development" or "Python programming"), and this Ability will find relevant Upwork jobs and read them out to you.
