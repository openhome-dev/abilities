...
class SalesforceCRMCapability(MatchingCapability):
    ...
    CONSUMER_KEY: ClassVar[str] = "xxxxxx"
    CONSUMER_SECRET: ClassVar[str] = "xxxx"
    INSTANCE_URL: ClassVar[str] = "https://orgfarm-e79624af49-dev-ed.develop.my.salesforce.com"
    INITIAL_ACCESS_TOKEN: ClassVar[str] = "xxxx"
    INITIAL_REFRESH_TOKEN: ClassVar[str] = "xxxxxx"
    ...
    async def speak_pipeline_summary(
        ...
        # Start with overview
        if total_deals == 1:
            response = f"Here's your pipeline. You have 1 open opportunity"
        else:
    ...
    async def complete_oauth_flow(self, prefs: dict) -> bool:
        ...
        auth_url = (
            ...
            f"redirect_uri=https://login.salesforce.com&"
